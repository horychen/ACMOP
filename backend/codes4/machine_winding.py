...
class MachineWinding:
    ...
    ps: int = 0 # Suspension pole pair count
    ...
    def get_InitialRotationAngle(self):
        ...
        self.initial_rotation_angle = (deg_pole_span - self.deg_alpha_rm.value) * 0.5 + self.wily.deg_winding_U_phase_phase_axis_angle
        return self.initial_rotation_angle

    def update_excitations(self):
        ...
        mm_r_sy = self.mm_r_so.value - self.mm_d_sy.value
        mm_r_ss = self.mm_r_si.value + self.mm_d_sts.value
        EX['mm2_slot_area'] = (math.pi*(mm_r_sy**2 - mm_r_ss**2) / Qs - self.mm_w_st.value * self.mm_d_st.value)
    ...
    def sync(self, geometry_points, materials, l_stack):
        ...
        # 0. Update geometric placeholders for excitation logic from AllPoints.HP
        g = geometry_points
        self.mm_r_si.value = g[4][0]
        self.mm_r_so.value = g[9][0]
        self.mm_r_ro.value = g[3][0]
        self.mm_d_sy.value = g[9][0] - g[8][0]
        self.mm_d_st.value = g[8][0] - g[5][0]
        self.mm_d_sts.value = g[5][0] - g[4][0]
        self.mm_d_pm.value = g[3][0] - g[2][0]
        self.mm_d_mech_air_gap.value = g[4][0] - g[3][0]
        ...
        self.EX['Magnet_StartAngle'] = 0 # Default
