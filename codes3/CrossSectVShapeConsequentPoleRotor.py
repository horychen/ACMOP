...
rotor_geometric_parameters = {
    0: ("fixed", "rotor_pole_pair_number",              "pr",           10),
    1: ("free",  "air_bridge_depth",                    "mm_d_bg_air",  1.5),
    2: ("free",  "magnet_bridge_depth",                 "mm_d_bg_magnet", 5),
    3: ("free",  "magnet_depth",                        "mm_d_pm",      9.4),
    4: ("free",  "magnet_rotation",                     "deg_alpha_pm", 20.3),
    5: ("free",  "rotor_outer_radius",                  "mm_r_or",      129.8),
    6: ("free",  "rotor_inter_radius",                  "mm_r_ir",      84.6),    
    7: ("free",  "rotor_inner_depth (back-iron depth)", "mm_d_ri",      15.86),
    8: ("derived", "magnet_width"                     , "mm_w_pm",      None)
}
