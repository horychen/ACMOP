...
def main_derivation():
    ...
    Slot_Pole_Combinations = [                        
                                ...
                                # (3, 24, 8, 7, 11, 0), # homopolar
                                # (3, 24, 8, 7, 10, 0), # homopolar 
                                # (3, 24, 8, 7, 9, 0), # homopolar 
                                # (3, 24, 8, 7, 8, 0), # homopolar 
                                # (3, 24, 8, 7, 7, 0), # homopolar 
                                # (3, 24, 8, 7, 6, 0), # homopolar 
                                # (3, 24, 8, 7, 5, 0), # homopolar 
                                # (3, 24, 8, 7, 4, 0), # homopolar 
                                # (3, 24, 8, 7, 3, 0), # homopolar 
                                # (3, 24, 8, 7, 2, 0), # homopolar 
                                # (3, 24, 8, 7, 1, 0), # homopolar 
