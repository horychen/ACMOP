...
class CrossSectConsequentSinglePoleRotor(object):
    # CrossSectInnerConsequentSinglePoleRotor Describes the inner ConsequentPole rotor.
    ...
    def __init__(self, 
                    name = 'ConsequentPole Single Rotor',
                    color = '#FE840E',
                    mm_d_pm = 6,
                    deg_alpha_rm = 60,
                    deg_alpha_rs = 10,
        ...
        self.deg_alpha_rs = deg_alpha_rs # magnet segment span angle: class type DimAngular
    ...
    def draw(self, drawer, bool_draw_whole_model=False):
        ...
        p        = self.p
        s        = self.s
        alpha_rp = 2*np.pi/(3*p) # pole span    
        alpha_rs = 0
        ...
        if s == 1:
            ...
            alpha_p6 = alpha_p5
            r_P6 = r_ri + d_ri
            P6 = [r_P6*cos(alpha_p6), r_P6*sin(alpha_p6)]
            P6_extra = [0, r_ri + 0.1]

            alpha_p7 = 3*alpha_rp
            r_P7 = r_P6
            P7 = [r_P7*cos(alpha_p7), r_P7*sin(alpha_p7)]


            alpha_p8 = alpha_p7
            r_P8 = r_ri
            P8 = [r_P8*cos(alpha_p8), r_P8*sin(alpha_p8)]
...
####################    ##### 非常有用！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！############################
                        ...
                        def draw_fraction(list_segments, P1, P2, P3, P4, P5, P6, P7, P8):
                            if (i % 2) == 0:
                                list_segments += drawer.drawLine(P1, P2)
                                ...
                                list_segments += drawer.drawArc([0,0], P6, P7)
                                list_segments += drawer.drawLine(P7, P8)
                                list_segments += drawer.drawArc([0,0], P1, P8)
                                # list_segments += drawer.drawLine(P7, P8)
####################    ##### 非常有用！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！############################
                        for i in range(2*p):
                            draw_fraction(list_segments, P1, P2, P3, P4, P5, P6, P7, P8)
                            # break
                        # quit()
...
class CrossSectConsequentSinglePoleMagnet(object):
    def __init__(self, 
                    name = 'ConsequentSinglePole',
                    color = '#0BA0E2',
                    ConsequentSinglePole_rotor = None,
                    ):
        self.name = name
        self.color = color
        self.ConsequentSinglePole_rotor = ConsequentSinglePole_rotor
    ...
    def draw(self, drawer, bool_re_evaluate= False, bool_draw_whole_model= False):
        ...
        d_pm     = self.ConsequentSinglePole_rotor.mm_d_pm
        alpha_rm = self.ConsequentSinglePole_rotor.deg_alpha_rm * np.pi/180
        alpha_rs = self.ConsequentSinglePole_rotor.deg_alpha_rs * np.pi/180
        r_ri     = self.ConsequentSinglePole_rotor.mm_r_ri
        d_ri     = self.ConsequentSinglePole_rotor.mm_d_ri
        d_rp     = self.ConsequentSinglePole_rotor.mm_d_rp
        d_rs     = self.ConsequentSinglePole_rotor.mm_d_rs
        p        = self.ConsequentSinglePole_rotor.p
        s        = self.ConsequentSinglePole_rotor.s
        alpha_rp = 2*np.pi/(3*p) # pole span
        alpha_rs = 0
        ...
        if abs(alpha_rp - alpha_rm) <= 2 * np.pi/180: # if alpha_rm and alpha_rp has a difference smaller than 2 deg, then let alpha_rm equal to alpha_rp.
            ...
            print('[Warn] [class CrossSectInnerConsequentSinglePoleMagnet] Magnet is fully spanned.')
        ...
        if True:
            ...
            print('[CrossSectInnerConsequentSinglePoleRotor.py] Magnet area in total is %g mm^2'%(self.mm2_magnet_area))
            if bool_re_evaluate:
            ...
            if bool_draw_whole_model:
                ...
                if 0:
                    ...
                    def draw_fraction(list_segments, P1, P2, P3, P4, P5, P6, P7, P8):
                        ...
                        list_segments += drawer.drawLine(P1, P2)
                        list_segments += drawer.drawArc([0,0], P2, P3)
                        list_segments += drawer.drawArc([0,0], P1, P4)
                        list_segments += drawer.drawLine(P3, P4)
                        # list_regions.append(list_segments)
                        # list_segments = []
                        ...
                        list_segments += drawer.drawLine(P5, P6)
                        list_segments += drawer.drawArc([0,0], P6, P7)
                        list_segments += drawer.drawArc([0,0], P5, P8)
                        list_segments += drawer.drawLine(P7, P8)
                        list_regions.append(list_segments)
                        list_segments = []
                        # quit()
                    # for i in range(1):
                    draw_fraction(list_segments, P1, 
                                                 P2, 
                                                 P3, 
                                                 P4,
                                                 P5,
        ...
        innerCoord1 = ( 0.5*(P1[0] + P3[0]), 0.5*(P1[1] + P3[1]))
        innerCoord2 = ( 0.5*(P5[0] + P7[0]), 0.5*(P5[1] + P7[1]))
        return {'innerCoord': [innerCoord1, innerCoord2], 'list_regions':list_regions, 'mirrorAxis': None}
        # return list_regions # csToken # cross section token
    # def draw2(self, drawer, bool_re_evaluate= False, bool_draw_whole_model= False):
    ...
    #                                                  P3, 
    #                                                  P4)
    #                     draw_fraction(list_segments, P5, 
    #                                                  P6, 
    #                                                  P7, 
    #                                                  P8)
    #                     # quit()
    ...
    #     innerCoord1 = ( 0.5*(P1[0] + P3[0]), 0.5*(P1[1] + P3[1]))
    #     innerCoord2 = ( 0.5*(P5[0] + P7[0]), 0.5*(P5[1] + P7[1]))
    #     return {'innerCoord': innerCoord2, 'list_regions':list_regions, 'mirrorAxis': None}
    #     # return list_regions # csToken # cross section token
...
class CrossSectSleeve(object):
    def __init__(self, 
                    name = 'Sleeve',
                    color = '#11E322',
                    ConsequentSinglePole_magnet = None,
                    d_sleeve = None
                    ):
        self.name = name
        self.color = color
        self.ConsequentSinglePole_magnet = ConsequentSinglePole_magnet
    ...
    def draw(self, drawer):
        ...
        r_ri  = self.ConsequentSinglePole_magnet.ConsequentSinglePole_rotor.mm_r_ri
        d_ri  = self.ConsequentSinglePole_magnet.ConsequentSinglePole_rotor.mm_d_ri
        d_pm  = self.ConsequentSinglePole_magnet.ConsequentSinglePole_rotor.mm_d_pm
        p     = self.ConsequentSinglePole_magnet.ConsequentSinglePole_rotor.p
...
if __name__ == '__main__':
    ...
    if True:
        ...
        ConsequentSinglePole_rotor = CrossSectConsequentSinglePoleRotor( name = 'NotchedRotor',
                                                    color = '#FE840E',
                                                    deg_alpha_rm = 60,
                                                    deg_alpha_rs = 10,
                                                    mm_d_ri = 8,
    ...
    if True:
        notched_magnet = CrossSectConsequentSinglePoleMagnet( name = 'RotorMagnet',
                                                      color = '#0E001E',
