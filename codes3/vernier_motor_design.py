...
class vernier_motor_VShapePM_template(object):
    def __init__(self, fea_config_dict=None, spec_input_dict=None, model_name_prefix='pmVM'):
...
class vernier_motor_VShapePM_design(vernier_motor_VShapePM_template):
